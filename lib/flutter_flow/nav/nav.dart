      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => Cadastro1Widget(
            ...
            googleFullName: params.getParam<String>(
              'googleFullName',
              ParamType.String,
              isList: true,
            ),
        ...
        FFRoute(
          ...
          path: Cadastro3Widget.routePath,
          builder: (context, params) => Cadastro3Widget(
            firstname: params.getParam(
              'firstname',
              ParamType.String,
            ),
            ...
            arecodeindex: params.getParam(
              'arecodeindex',
              ParamType.int,
            ),
            estadoUFindex: params.getParam(
              'estadoUFindex',
              ParamType.int,
            ),
            ...
            specialtyindex: params.getParam(
              'specialtyindex',
              ParamType.int,
            ),
          ),
