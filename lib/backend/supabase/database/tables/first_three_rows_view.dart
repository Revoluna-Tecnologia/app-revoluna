...
class FirstThreeRowsViewTable extends SupabaseTable<FirstThreeRowsViewRow> {
  @override
  String get tableName => 'first_three_rows_view';

  @override
  FirstThreeRowsViewRow createRow(Map<String, dynamic> data) =>
      FirstThreeRowsViewRow(data);
}

class FirstThreeRowsViewRow extends SupabaseDataRow {
  FirstThreeRowsViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FirstThreeRowsViewTable();
