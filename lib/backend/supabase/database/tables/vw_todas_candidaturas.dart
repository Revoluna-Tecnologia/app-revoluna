...
class VwTodasCandidaturasTable extends SupabaseTable<VwTodasCandidaturasRow> {
  @override
  String get tableName => 'vw_todas_candidaturas';

  @override
  VwTodasCandidaturasRow createRow(Map<String, dynamic> data) =>
      VwTodasCandidaturasRow(data);
}

class VwTodasCandidaturasRow extends SupabaseDataRow {
  VwTodasCandidaturasRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwTodasCandidaturasTable();
