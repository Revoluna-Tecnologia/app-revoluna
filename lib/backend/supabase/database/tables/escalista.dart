...
class EscalistaTable extends SupabaseTable<EscalistaRow> {
  @override
  String get tableName => 'escalista';

  @override
  EscalistaRow createRow(Map<String, dynamic> data) => EscalistaRow(data);
}

class EscalistaRow extends SupabaseDataRow {
  EscalistaRow(Map<String, dynamic> data) : super(data);
