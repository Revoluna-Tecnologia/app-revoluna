...
class VagasCompletoTable extends SupabaseTable<VagasCompletoRow> {
  @override
  String get tableName => 'vagas_completo';

  @override
  VagasCompletoRow createRow(Map<String, dynamic> data) =>
      VagasCompletoRow(data);
}

class VagasCompletoRow extends SupabaseDataRow {
  VagasCompletoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VagasCompletoTable();
