                                ...
                                children: [
                                  Builder(
                                    builder: (context) {
                                      ...
                                      } else if (widget!.shift == 'Cinderela') {
                                        return Icon(
                                          FFIcons.kcinderela,
                                          color: FlutterFlowTheme.of(context)
                                              .primary,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.deleteCandidatura != null &&
                                      (_model.deleteCandidatura)!.isNotEmpty) {
